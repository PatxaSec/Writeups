...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_1.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_1.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_2.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_2.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_3.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_3.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_4.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_4.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_5.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_5.png)

Under 'Active solution platform', students need to click on '<New...>':

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_6.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_6.png)

Students need to select `x64`:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_7.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_7.png)

Students also need to change the 'Active solution configuration' to `Release`:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_8.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_8.png)

Afterward, students need to build the solution with the keystrokes `Ctrl + Shift + B`:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_9.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_9.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_10.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_10.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_11.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_11.png)

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_12.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_12.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_13.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_13.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_14.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_14.png)

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_15.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_15.png)

Students then need to develop C# code (as provided in the section) that abuses `InstallUtil` to establish a reverse shell, utilizing either the custom-built reverse shell, 'RShell', provided in the `Dynamic Analysis` section or [micr0_shell](https://github.com/senzee1984/micr0_shell) (the former approach will be used):
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_16.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_16.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_17.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_17.png)

Then, inside the `NuGet Package Manager`, students need to click on the `Settings` (gear) icon:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_18.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_18.png)

Students need to uncheck the first two checkboxes only to have `Hack The Box` as the packages source:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_19.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_19.png)

Subsequently, students need to install the `DllExport` `NuGet` package:

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_20.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_20.png)

When prompted by `DllExport` to apply changes, students need to check the 'Installed' checkbox and choose 'Install':

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_21.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_21.png)

Afterward, students need to choose 'Reload All':

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_22.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_22.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_23.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_23.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_24.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_24.png)

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_25.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_25.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_26.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_26.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_27.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_27.png)

![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_28.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_28.png)
...
![Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_29.png](https://academy.hackthebox.com/storage/walkthroughs/144/Introduction_to_Windows_Evasion_Techniques_Walkthrough_Image_29.png)
