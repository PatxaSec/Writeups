...
### "Use WMI queries with the class Win32_OperatingSystem to retrieve information about SRV02. What's the serial number of the OS for SRV02:"
...
### "Use WMI queries with the class Win32_OperatingSystem to retrieve information about SRV02. What's the InstallDate value for SRV02:"
...
![Windows_Lateral_Movement_Walkthrough_Image_1.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_1.png)

![Windows_Lateral_Movement_Walkthrough_Image_2.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_2.png)

Subsequently, students will proceed to use the credentials `admin:RemoteManagement01` to log in to `MeshCentral`:

![Windows_Lateral_Movement_Walkthrough_Image_3.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_3.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_4.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_4.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_5.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_5.png)

Subsequently, students will select `Terminal`:

![Windows_Lateral_Movement_Walkthrough_Image_6.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_6.png)

Click on the `Connect` button to start an interactive terminal session:

![Windows_Lateral_Movement_Walkthrough_Image_7.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_7.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_8.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_8.png)

![Windows_Lateral_Movement_Walkthrough_Image_9.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_9.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_10.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_10.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_11.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_11.png)

If needed students will right-click on the update and `Retry Download`:

![Windows_Lateral_Movement_Walkthrough_Image_12.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_12.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_13.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_13.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_14.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_14.png)

Students will be presented with a `PowerShell` console, where they can execute commands.

![Windows_Lateral_Movement_Walkthrough_Image_15.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_15.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_16.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_16.png)

![Windows_Lateral_Movement_Walkthrough_Image_17.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_17.png)

![Windows_Lateral_Movement_Walkthrough_Image_18.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_18.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_19.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_19.png)

They will navigate to `WSUS` -> `Updates` -> `All Updates`:

![Windows_Lateral_Movement_Walkthrough_Image_20.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_20.png)

Students will change the `Status` to `Any` and will click on `Refresh`:

![Windows_Lateral_Movement_Walkthrough_Image_21.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_21.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_22.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_22.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_23.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_23.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_24.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_24.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_25.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_25.png)

They will right-click on their update and `Retry Download`:

![Windows_Lateral_Movement_Walkthrough_Image_26.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_26.png)
...
![Windows_Lateral_Movement_Walkthrough_Image_27.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_27.png)

Students will notice that login information has been saved in the browser, which they can reuse to log in:

![Windows_Lateral_Movement_Walkthrough_Image_28.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_28.png)

Subsequently, students will click on the `DC` agent:

![Windows_Lateral_Movement_Walkthrough_Image_29.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_29.png)

Then navigate to `Terminal`:

![Windows_Lateral_Movement_Walkthrough_Image_30.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_30.png)

They will establish a connection with the Agent by clicking on `Connect`:

![Windows_Lateral_Movement_Walkthrough_Image_31.png](https://academy.hackthebox.com/storage/walkthroughs/150/Windows_Lateral_Movement_Walkthrough_Image_31.png)
