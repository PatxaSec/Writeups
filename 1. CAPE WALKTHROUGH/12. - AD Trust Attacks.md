...
### "Perform the ADCS attack and request a certificate on behalf of "Tom". What is the flag value located at "\\DC01\ADCS_flag\flag.txt"?"
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_1.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_1.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_2.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_2.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_3.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_3.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_4.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_4.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_5.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_5.png)

![Active_Directory_Trust_Attacks_Walkthrough_Image_6.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_6.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_7.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_7.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_8.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_8.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_9.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_9.png)

Within the `Properties` window, students need to select the `Security` tab where they need to click on `Advanced`:

![Active_Directory_Trust_Attacks_Walkthrough_Image_10.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_10.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_11.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_11.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_12.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_12.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_13.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_13.png)

Within the attribute editor, students need to locate the `certificateTemplates` attribute and edit it:

![Active_Directory_Trust_Attacks_Walkthrough_Image_14.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_14.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_15.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_15.png)
...
### "Perform a GPO on-site attack to reset the password of the user 'gpo_admin' in the parent domain and submit the flag located at "\\DC01\GPO_flag\flag.txt"."
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_16.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_16.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_17.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_17.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_18.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_18.png)
...
### "What is the SID (objectSid) value of the "gmsa_adm$" account?"
...
### "Compromise the "gmsa_adm$" account and submit the flag at "\\DC01\GMSA_flag\flag.txt""
...
### "Follow the example shown above and authenticate as user "buster". Submit the flag located at "\\DC01\DNS_flag\flag.txt". (The flag is accessible by the "inlanefreight\buster" user)"
...
### "Abuse ACLs to add the user "Rita" into the "Infrastructure" group. Submit the flag located at "\\DC01\Infrastructure_flag\flag.txt" (The flag is accessible by the "inlanefreight\Infrastructure" group)"
...
### "Abuse the Foreign Group membership of the user "jerry" and submit the flag value located at "\\DC01\Inlanefreight_flag\flag.txt" (The flag is accessible by the "inlanefreight\Inlanefreight_admins" group)"
...
### "Authenticate to DC01.inlanefreight.ad (172.16.118.3) and perform "SID History Injection" to compromise the Logistics Domain. What is the flag value at "\\DC02.logistics.ad\SID_Flag\flag.txt"?"
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_19.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_19.png)
...
### "Authenticate to DC01.inlanefreight.ad (172.16.118.3) and abuse the Foreign Group membership of the user "harry". What is the flag value located at "\\DC02.logistics.ad\FSP_Flag\flag.txt"? (The flag is accessible by the "logistics\svc_admins" group)"
...
### "Authenticate to DC01.inlanefreight.ad (172.16.118.3) and abuse the foreign ACLs of the user "ava". What is the flag value located at "\\DC02.logistics.ad\FSP_ACL\flag.txt"? (The flag is accessible by the user "logistics\jessica")"
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_20.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_20.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_21.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_21.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_22.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_22.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_23.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_23.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_24.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_24.png)
...
![Active_Directory_Trust_Attacks_Walkthrough_Image_25.png](https://academy.hackthebox.com/storage/walkthroughs/143/Active_Directory_Trust_Attacks_Walkthrough_Image_25.png)
