...
El reconocimiento previo a un ataque es una fase crucial que nos permite recolectar información sobre la red y los dispositivos conectados antes de lanzar un ataque más elaborado. A continuación, se presentan técnicas y herramientas usadas frecuentemente para realizar un reconocimiento efectivo en redes MGT.

---

# Análisis de Identidades de Usuarios
...
![](https://files.cdn.thinkific.com/file_uploads/937577/images/3b0/d81/17d/1724018496385.png?width=1920)

Wireshark con filtro EAP para obtener Identidades

Alternativamente, se puede usar la herramienta wifi_db para extraer esta información de forma más automatizada.
```
...
![](https://files.cdn.thinkific.com/file_uploads/937577/images/6bb/1e1/9c8/1724018496402.png?width=1920)

Información de identidades en base de datos de wifi_db
...
```
![](https://files.cdn.thinkific.com/file_uploads/937577/images/c24/441/6a8/1724018510860.png?width=1920)

Información del certificado del AP
...
```
![](https://files.cdn.thinkific.com/file_uploads/937577/images/962/0c0/290/1724018539111.png?width=1920)

Uso de EAP búster para verificar los métodos soportados
