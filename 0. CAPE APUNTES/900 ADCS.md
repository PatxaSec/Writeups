```
 if right in (
                                         "AdminTo", "GenericAll", "GenericWrite", "WriteOwner", "WriteDacl", "W>
                                         "ReadProperty", "ExtendedRight", "AllExtendedRights", "ForceChangePass>
                                         "ResetPassword", "WriteAccountRestrictions", "AddMember", "MemberOf", >
                                         "AllowedToDelegate", "AllowedToAct", "HasSession", "CanRDP", "ExecuteD>
                                         "AddSelf", "RemoveSelf", "ReadLAPSPassword", "ReadGMSAPassword", "DCSy>
                                         "GetChangesAll", "ManageGroup", "ShadowCredential", "UserRights", "Sel>
                                         "AddMembers", "GenericRead", "GenericExecute", "Write", "Add", "Remove>
                                         "AZTenant", "AZUser", "AZGroup", "AZApp", "AZSubscription", "AZResourc>
                                         "AZVM", "AZDevice", "AZServicePrincipal", "AZAddMembers", "AZAddOwner">
                                         "AZCloudAppAdmin", "AZContains", "AZContributor", "AZExecuteCommand", >
                                         "AZGetKeys", "AZGetSecrets", "AZGlobalAdmin", "AZKeyVaultContributor",>
                                         "AZOwns", "AZPrivilegedRoleAdmin", "AZResetPassword", "AZRunAs", "AZUs>
                                        "AZVMAdminLogin"
                                 ):
```
