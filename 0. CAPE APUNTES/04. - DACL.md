...
Internamente, Windows representa un `security descriptor` a través de la [estructura de SEGURIDAD:](https://learn.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-security_descriptor)
